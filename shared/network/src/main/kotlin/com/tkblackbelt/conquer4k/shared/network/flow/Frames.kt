package com.tkblackbelt.conquer4k.shared.network.flow
...
fun ByteReadChannel.decryptedFrames(cipher: PacketCipher): Flow<Buffer> =
    flow {
        ...
        while (true) {
            ...
            while (true) {
                if (state == NEED_HEADER) {
                    ...
                    val frameSize = cipher.decryptShortLe(encLen).toInt()
